...
public class Ventas {
	...
	public static void main(String[] args) {
		try(RandomAccessFile fVentas = 
			new RandomAccessFile("C:\\Users\\malimon\\Desktop\\VentasMayo.dat","rw")
			){
...
//	public static void generarFicheroErrores(fVentas){
//		try(RandomAccessFile fErrores = new "C:\\Users\\malimon\\Desktop\\Errores.dat","rw")
...
//	}
	...
	public static void informeVentasMes(RandomAccessFile fVentas) throws IOException {
		...
		double totalVentasMes=0,totalVentasCliente=0,importeVenta;
